...
export default function AddTaskButton({ onAddTask, folders }) {
  ...
  const handleAddTask = (e) => {
    ...
    const newTaskObj = {
      ...
      text: newTask,
      completed: false,
      folderId: Number.parseInt(newTaskFolder),
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[10000]">
          <div className="bg-[#051640] text-white rounded-lg shadow-xl w-full max-w-md mx-4 p-5">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold text-[#A7E8D2]">Add New Task</h2>
              <Button 
                variant="ghost" 
                size="sm" 
            ...
            <form onSubmit={handleAddTask}>
              <div className="space-y-4 py-2">
                <div className="space-y-2">
                  <Label htmlFor="task-text" className="text-gray-300">Task Description</Label>
                  <Input
                    id="task-text"
                    value={newTask}
                ...
                <div className="space-y-2">
                  <Label htmlFor="task-folder" className="text-gray-300">Folder</Label>
              ...
              <div className="flex justify-end gap-2 mt-4">
                ...
                <Button 
                  type="submit" 
                  className="bg-[#A7E8D2] text-[#020F2B] hover:bg-[#A7E8D2]/80 font-medium"
                >
                  Add Task
                </Button>
              </div>
